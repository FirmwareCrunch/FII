...
from FII.unicorn.arch_unicorn import ArchUnicorn
from FII.unicorn.emulator import UnicornEmulator, UnicornEmulatorFrontend
...
class PluginUnicornEmulator(FiiPlugin):

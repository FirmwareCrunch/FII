...
from FII.core.dev_utils import pkg_object_loader, inherits_from
from FII.core.ctypes.ctypes_base import (
    CBaseType, DataPointerBase, CodePointerBase, IntegralType, FloatType,
    Char, Bool, _Bool)
from FII.core.cc_base import FuncArg, ReturnValue
...
class UnicornFunctionTracer:
    LOGGER_NAME = 'FII.unicorn_function_tracer'

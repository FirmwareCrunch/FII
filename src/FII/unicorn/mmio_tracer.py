...
from FII.core.emulator_types import ADDRESS_FORMAT
from FII.core.cmsis_svd import SvdIndex, SvdLoader
...
class UnicornMmioTracer:
    LOGGER_NAME = 'FII.unicorn_mmio_tracer'
...
class UnicornMmioDbg:
    LOGGER_NAME = 'FII.unicorn_mmio_dbg'

...
meta_blob_arm_el_32_mem_read_unmapped = \
  {'arch_unicorn': 'arm:el:32:926',
   ...
   'disassembly': '\n'
                  ...
                  '   20004:  e5901000   ldr  r1, [r0]\n'
                  '\n'
                  '00020008 <emu_end>:\n'
                  '   20008:  e1a00000   nop      @ (mov r0, r0)\n',
   'mapped_blobs': [{'loading_address': 131072,
                     'blob': b'\xff\x08\xa0\xe3\x00\x10\x90\xe5\x00\x00\xa0\xe1'}],
   'extra': {}}

BlobArmEl32MemReadUnmapped = MetaBinBlob.from_dict(meta_blob_arm_el_32_mem_read_unmapped)

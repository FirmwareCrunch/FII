...
meta_blob_arm_el_32_mem_write_unmapped = \
  {'arch_unicorn': 'arm:el:32:926',
   ...
   'disassembly': '\n'
                  ...
                  '\n'
                  '00020000 <__main__>:\n'
                  '   20000:  e3a01000   mov  r1, #0\n'
                  '   20004:  e3a008ff   mov  r0, #16711680  @ 0xff0000\n'
                  '   20008:  e5801000   str  r1, [r0]\n'
                  '\n'
                  '0002000c <emu_end>:\n'
                  '   2000c:  e1a00000   nop      @ (mov r0, r0)\n',
   'mapped_blobs': [{'loading_address': 131072,
                     'blob': b'\x00\x10\xa0\xe3\xff\x08\xa0\xe3\x00\x10\x80\xe5\x00\x00\xa0\xe1'}],
   'extra': {}}

BlobArmEl32MemWriteUnmapped = MetaBinBlob.from_dict(meta_blob_arm_el_32_mem_write_unmapped)

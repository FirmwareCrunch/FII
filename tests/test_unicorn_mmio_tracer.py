...
from FII.core.cmsis_svd import SvdLoader, SvdIndex
from FII.unicorn.mmio_tracer import MmioFilter, RegisterField
...
def test_mmio_filter_keep_from_address():
...
def test_mmio_filter_exclude_from_address():
...
def test_mmio_filter_keep_address():
...
def test_mmio_filter_exclude_address():
...
def test_mmio_filter_register_state_change():
...
def test_mmio_filter_register_field_change():
...
def test_mmio_filter_svd_filter_peripheral_keep():
...
def test_mmio_filter_svd_filter_peripheral_exclude():
    dev = SvdLoader().load('./fixtures/cmsis-svd/Toshiba_M367.svd')
...
def test_mmio_filter_svd_filter_register_keep():
    dev = SvdLoader().load('./fixtures/cmsis-svd/Toshiba_M367.svd')
...
def test_mmio_filter_svd_filter_register_exclude():
    dev = SvdLoader().load('./fixtures/cmsis-svd/Toshiba_M367.svd')
...
def test_mmio_filter_svd_filter_register_state_change():
    dev = SvdLoader().load('./fixtures/cmsis-svd/Toshiba_M367.svd')
...
def test_mmio_filter_svd_filter_field_state_change():
    dev = SvdLoader().load('./fixtures/cmsis-svd/Toshiba_M367.svd')
...
def test_mmio_filter_svd_filter_keep_from_address():
    dev = SvdLoader().load('./fixtures/cmsis-svd/Toshiba_M367.svd')
    mmio_filter = MmioFilter(filter_keep_from_address:={0xffff00f0},
                             svd_index=SvdIndex(dev))
    assert mmio_filter.svd_filter_is_active()
...
def test_mmio_filter_svd_filter_exclude_from_address():
    dev = SvdLoader().load('./fixtures/cmsis-svd/Toshiba_M367.svd')
